...
function App() {
  ...
  useEffect(() => {
    ...
    if (!home || !about || !aboutShell || !('IntersectionObserver' in window)) return;

    // Observer for "about" section transition
  ...
  return (
    <div className="App">
      ...
      <main>
        ...
        <section id="about" className="page-section section-even reveal">
  ...
  <div className="portfolio-logo-item">
    ...
    >
      <img src="/Moneytree_logo.png" alt="MoneyTree" className="portfolio-logo-img" />
        ...
        <section id="news" className="page-section section-even">
  ...
  {[
    ...
    <article key={item.id} className="news-card reveal">
      ...
      <div className="news-body">
        ...
        <section id="clients" className="page-section section-odd reveal">
          <div className="clients-container">
            ...
            <div className="marquee-wrapper">
              <div className="marquee-content">
                {/* Duplicate the set of logos to ensure seamless scrolling */}
                {[...Array(2)].map((_, i) => (
            ...
            <div className="leaders-grid">
              <div className="leader-card reveal">
                <div className="leader-image-wrapper">
                  <img src="/ceo.jpg" alt="CEO" className="leader-image" />
                </div>
          ...
          <div className="why-us-container">
            ...
            <div className="why-us-grid">
              ...
              <div className="why-us-item reveal">
                ...
                <h3 className="why-us-title">PROJECT TIMELINE RECOVERY</h3>
                <p className="why-us-desc">
                  We have performed countless project recovery missions whereby conventional welding has failed
                  to deliver pipelines to agreed project deadlines. How about 25-km of 12-inch carbon steel
                  with 47 expansion loops and 12 major road crossings? Timeline – 16 days after two days of mobilization.
                </p>
              </div>
              ...
              <div className="why-us-item reveal">
                <div className="why-us-icon">
                  <svg viewBox="0 0 24 24" width="64" height="64" stroke="currentColor" strokeWidth="1.5" fill="none">
                    ...
                    <path d="M12 4c4 0 9 .5 9 1" />
                  </svg>
                </div>
                <h3 className="why-us-title">OIL PRODUCTION ACCELERATION</h3>
                <p className="why-us-desc">
                  Many national economies and global Oil & Gas operators are dependent on accelerated production
                  volumes in order to maintain margin over and above their fixed operating costs. Through its
                  fast pipeline construction, Stealth-Lock is an important partner to increasing volume production
                  ready for export.
                </p>
              </div>
              ...
              <div className="why-us-item reveal">
                ...
                <h3 className="why-us-title">FASTER FLOW-LINE DEVELOPMENT</h3>
                <p className="why-us-desc">
                  If you consider that with welding, it might take a four-year contract to complete a gathering
                  network comprising of over 300 hook ups. Then, consider Stealth-Lock that performed its
                  scope in 14 months! Substantial operational cost savings, not to mention the hydrocarbon
              ...
              <div className="why-us-item reveal">
                ...
                <h3 className="why-us-title">PROJECT & PROGRAMME MANAGEMENT</h3>
                <p className="why-us-desc">
                  We are a group of multi-skilled and diverse business advisors experienced in global markets,
                  specifically the Middle East. Our practitioners have worked in the United States, Europe,
                  and across the Middle East in Finance/Banking, Oil, Gas & Energy, Transaction Advisory,
      ...
      {videoModalOpen && (
        <div className="video-modal-overlay" onClick={() => setVideoModalOpen(false)}>
          <div className="video-modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="video-modal-frame-wrapper">
              <iframe
